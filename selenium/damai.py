...
# target_url = "https://detail.damai.cn/item.htm?spm=a2oeg.home.card_0.ditem_1.1c5023e15JahrV&id=733193814511"
...
class Concert:
    def __init__(self):
        ...
        try:
            # self.driver = webdriver.Chrome(executable_path='C:/Users/kaixin/.cache/selenium/chromedriver/win32/108.0.5359.71/chromedriver.exe')  # 默认Chrome浏览器
